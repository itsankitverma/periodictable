...
//   return (
//     <>
//       <div className="Group18">{props.text}</div>
//     </>
//   );
// }
...
export default function Group4(props) {
  ...
  return (
    <Card className="Group18" style={props.style}>
      <CardContent>
        <Typography style={{ position:"relative", top:"-29px", left:"-23px", fontSize:"12px", color:"white"}} color="textSecondary">
          {props.number} 
        </Typography>        
        <Typography variant="body2" component="p" style={{ position:"relative", top:"-40px", left:"-10px", fontSize:"20px"}}>
        {props.text}
          <br />
